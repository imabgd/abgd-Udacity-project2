...
Locust Load Testing in Azure Shell:
(.flask-ml-azure) abhijeet@Azure:~/abgd-Udacity-project2$ locust -f locustfile.py --headless -u 1000 -r 100 --host=https://abgd-flask.azurewebsites.net/
[2020-12-22 05:38:28,625] cc-895b0de9-5d96fb5668-gkfbb/INFO/locust.main: Starting Locust 1.0.1
[2020-12-22 05:38:28,627] cc-895b0de9-5d96fb5668-gkfbb/INFO/locust.runners: Hatching and swarming 1000 users at the rate 100 users/s (0 users already running)...
...
--------------------------------------------------------------------------------------------------------------------------------------------
 ...
 Name                                                          # reqs      # fails     Avg     Min     Max  |  Median   req/s failures/s
--------------------------------------------------------------------------------------------------------------------------------------------
 GET //                                                            90     0(0.00%)     859     251    1185  |    1000    0.00    0.00
--------------------------------------------------------------------------------------------------------------------------------------------
 Aggregated                                                        90     0(0.00%)     859     251    1185  |    1000    0.00    0.00

 Name                                                          # reqs      # fails     Avg     Min     Max  |  Median   req/s failures/s
--------------------------------------------------------------------------------------------------------------------------------------------
 GET //                                                           341     0(0.00%)     765     250    1459  |     800   16.50    0.00
--------------------------------------------------------------------------------------------------------------------------------------------
 Aggregated                                                       341     0(0.00%)     765     250    1459  |     800   16.50    0.00

 Name                                                          # reqs      # fails     Avg     Min     Max  |  Median   req/s failures/s
--------------------------------------------------------------------------------------------------------------------------------------------
 GET //                                                           492     0(0.00%)    1100     250    2787  |    1000   67.75    0.00
--------------------------------------------------------------------------------------------------------------------------------------------
 Aggregated                                                       492     0(0.00%)    1100     250    2787  |    1000   67.75    0.00

 Name                                                          # reqs      # fails     Avg     Min     Max  |  Median   req/s failures/s
--------------------------------------------------------------------------------------------------------------------------------------------
 GET //                                                           765     0(0.00%)    1615     250    3080  |    1700   74.83    0.00
--------------------------------------------------------------------------------------------------------------------------------------------
 Aggregated                                                       765     0(0.00%)    1615     250    3080  |    1700   74.83    0.00

 Name                                                          # reqs      # fails     Avg     Min     Max  |  Median   req/s failures/s
--------------------------------------------------------------------------------------------------------------------------------------------
 GET //                                                          1072     0(0.00%)    1906     250    3330  |    2200   85.38    0.00
--------------------------------------------------------------------------------------------------------------------------------------------
 Aggregated                                                      1072     0(0.00%)    1906     250    3330  |    2200   85.38    0.00

 Name                                                          # reqs      # fails     Avg     Min     Max  |  Median   req/s failures/s
--------------------------------------------------------------------------------------------------------------------------------------------
 GET //                                                          1259     0(0.00%)    2097     250    4425  |    2300   97.10    0.00
--------------------------------------------------------------------------------------------------------------------------------------------
 Aggregated                                                      1259     0(0.00%)    2097     250    4425  |    2300   97.10    0.00

 Name                                                          # reqs      # fails     Avg     Min     Max  |  Median   req/s failures/s
--------------------------------------------------------------------------------------------------------------------------------------------
 GET //                                                          1527     0(0.00%)    2457     250    5150  |    2400  119.20    0.00
--------------------------------------------------------------------------------------------------------------------------------------------
 Aggregated                                                      1527     0(0.00%)    2457     250    5150  |    2400  119.20    0.00

[2020-12-22 05:38:43,660] cc-895b0de9-5d96fb5668-gkfbb/WARNING/root: Loadgen CPU usage above 90%! This may constrain your throughput and may even give inconsistent response time measurements! See https://docs.locust.io/en/stable/running-locust-distributed.html for how to distribute the load over multiple CPU cores or machines
[2020-12-22 05:38:43,917] cc-895b0de9-5d96fb5668-gkfbb/INFO/locust.runners: All users hatched: QuickstartUser: 1000 (0 already running)
 Name                                                          # reqs      # fails     Avg     Min     Max  |  Median   req/s failures/s
--------------------------------------------------------------------------------------------------------------------------------------------
 GET //                                                          1753     0(0.00%)    2759     250    5908  |    2800  117.40    0.00
--------------------------------------------------------------------------------------------------------------------------------------------
 Aggregated                                                      1753     0(0.00%)    2759     250    5908  |    2800  117.40    0.00

 Name                                                          # reqs      # fails     Avg     Min     Max  |  Median   req/s failures/s
--------------------------------------------------------------------------------------------------------------------------------------------
 GET //                                                          2060     0(0.00%)    3193     250    6318  |    3000  127.90    0.00
--------------------------------------------------------------------------------------------------------------------------------------------
 Aggregated                                                      2060     0(0.00%)    3193     250    6318  |    3000  127.90    0.00

 Name                                                          # reqs      # fails     Avg     Min     Max  |  Median   req/s failures/s
--------------------------------------------------------------------------------------------------------------------------------------------
 GET //                                                          2349     0(0.00%)    3519     250    6708  |    3300  128.90    0.00
--------------------------------------------------------------------------------------------------------------------------------------------
 Aggregated                                                      2349     0(0.00%)    3519     250    6708  |    3300  128.90    0.00

 Name                                                          # reqs      # fails     Avg     Min     Max  |  Median   req/s failures/s
--------------------------------------------------------------------------------------------------------------------------------------------
 GET //                                                          2561     0(0.00%)    3786     250    7686  |    3700  130.20    0.00
--------------------------------------------------------------------------------------------------------------------------------------------
 Aggregated                                                      2561     0(0.00%)    3786     250    7686  |    3700  130.20    0.00

 Name                                                          # reqs      # fails     Avg     Min     Max  |  Median   req/s failures/s
--------------------------------------------------------------------------------------------------------------------------------------------
 GET //                                                          2862     0(0.00%)    4133     250    7927  |    4300  124.50    0.00
--------------------------------------------------------------------------------------------------------------------------------------------
 Aggregated                                                      2862     0(0.00%)    4133     250    7927  |    4300  124.50    0.00

 Name                                                          # reqs      # fails     Avg     Min     Max  |  Median   req/s failures/s
--------------------------------------------------------------------------------------------------------------------------------------------
 GET //                                                          3125     0(0.00%)    4357     250    7927  |    4500  132.90    0.00
--------------------------------------------------------------------------------------------------------------------------------------------
 Aggregated                                                      3125     0(0.00%)    4357     250    7927  |    4500  132.90    0.00

 Name                                                          # reqs      # fails     Avg     Min     Max  |  Median   req/s failures/s
--------------------------------------------------------------------------------------------------------------------------------------------
 GET //                                                          3438     0(0.00%)    4592     250    7927  |    5300  134.90    0.00
--------------------------------------------------------------------------------------------------------------------------------------------
 Aggregated                                                      3438     0(0.00%)    4592     250    7927  |    5300  134.90    0.00

 Name                                                          # reqs      # fails     Avg     Min     Max  |  Median   req/s failures/s
--------------------------------------------------------------------------------------------------------------------------------------------
 GET //                                                          3773     0(0.00%)    4734     250    7927  |    5400  137.30    0.00
--------------------------------------------------------------------------------------------------------------------------------------------
 Aggregated                                                      3773     0(0.00%)    4734     250    7927  |    5400  137.30    0.00

 Name                                                          # reqs      # fails     Avg     Min     Max  |  Median   req/s failures/s
--------------------------------------------------------------------------------------------------------------------------------------------
 GET //                                                          3960     0(0.00%)    4826     250    7927  |    5500  140.50    0.00
--------------------------------------------------------------------------------------------------------------------------------------------
 Aggregated                                                      3960     0(0.00%)    4826     250    7927  |    5500  140.50    0.00

 Name                                                          # reqs      # fails     Avg     Min     Max  |  Median   req/s failures/s
--------------------------------------------------------------------------------------------------------------------------------------------
 GET //                                                          4239     0(0.00%)    4964     250    7927  |    5800  139.50    0.00
--------------------------------------------------------------------------------------------------------------------------------------------
 Aggregated                                                      4239     0(0.00%)    4964     250    7927  |    5800  139.50    0.00

 Name                                                          # reqs      # fails     Avg     Min     Max  |  Median   req/s failures/s
--------------------------------------------------------------------------------------------------------------------------------------------
 GET //                                                          4450     0(0.00%)    5058     250    7927  |    6000  136.50    0.00
--------------------------------------------------------------------------------------------------------------------------------------------
 Aggregated                                                      4450     0(0.00%)    5058     250    7927  |    6000  136.50    0.00

 Name                                                          # reqs      # fails     Avg     Min     Max  |  Median   req/s failures/s
--------------------------------------------------------------------------------------------------------------------------------------------
 GET //                                                          4773     0(0.00%)    5221     250    7927  |    6100  134.00    0.00
--------------------------------------------------------------------------------------------------------------------------------------------
 Aggregated                                                      4773     0(0.00%)    5221     250    7927  |    6100  134.00    0.00

 Name                                                          # reqs      # fails     Avg     Min     Max  |  Median   req/s failures/s
--------------------------------------------------------------------------------------------------------------------------------------------
 GET //                                                          5127     0(0.00%)    5321     250    7927  |    6200  133.60    0.00
--------------------------------------------------------------------------------------------------------------------------------------------
 Aggregated                                                      5127     0(0.00%)    5321     250    7927  |    6200  133.60    0.00

^CKeyboardInterrupt
2020-12-22T05:39:09Z
[2020-12-22 05:39:09,556] cc-895b0de9-5d96fb5668-gkfbb/INFO/locust.main: Shutting down (exit code 0), bye.
[2020-12-22 05:39:09,556] cc-895b0de9-5d96fb5668-gkfbb/INFO/locust.main: Cleaning up runner...
[2020-12-22 05:39:10,989] cc-895b0de9-5d96fb5668-gkfbb/WARNING/locust.runners: Loadgen CPU usage was too high at some point during the test! See https://docs.locust.io/en/stable/running-locust-distributed.html for how to distribute the load over multiple CPU cores or machines
[2020-12-22 05:39:10,990] cc-895b0de9-5d96fb5668-gkfbb/INFO/locust.main: Running teardowns...
 Name                                                          # reqs      # fails     Avg     Min     Max  |  Median   req/s failures/s
--------------------------------------------------------------------------------------------------------------------------------------------
 GET //                                                          5269     0(0.00%)    5359     250    7927  |    6300  124.72    0.00
--------------------------------------------------------------------------------------------------------------------------------------------
 Aggregated                                                      5269     0(0.00%)    5359     250    7927  |    6300  124.72    0.00

Percentage of the requests completed within given times
 Type                 Name                                                           # reqs    50%    66%    75%    80%    90%    95%    98%    99%99.9% 99.99%   100%
------------------------------------------------------------------------------------------------------------------------------------------------------
 GET                  //                                                               5269   6300   6700   6900   7000   7200   7500   7600   7700 7900   7900   7900
------------------------------------------------------------------------------------------------------------------------------------------------------
 None                 Aggregated                                                       5269   6300   6700   6900   7000   7200   7500   7600   7700 7900   7900   7900

(.flask-ml-azure) abhijeet@Azure:~/abgd-Udacity-project2$

### Locust Load Testing Screenshots:

![image](https://user-images.githubusercontent.com/74898057/102854263-3015c800-4448-11eb-9061-523ba34a38cd.png)
![image](https://user-images.githubusercontent.com/74898057/102854289-44f25b80-4448-11eb-9f06-be3a2e22fcdb.png)
![image](https://user-images.githubusercontent.com/74898057/102854355-5d627600-4448-11eb-836c-a670b753033f.png)
![image](https://user-images.githubusercontent.com/74898057/102854373-68b5a180-4448-11eb-9104-9f979f015d56.png)
![image](https://user-images.githubusercontent.com/74898057/102854388-73703680-4448-11eb-84e4-bdfa801457f3.png)
